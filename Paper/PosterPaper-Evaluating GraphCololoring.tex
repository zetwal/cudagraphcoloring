...
The tests were carried out on different categories of real graphs from the University of Florida Sparse Matrix Collection []. In this paper we will focus on 3 graphs from the Civil Engineering domain:
