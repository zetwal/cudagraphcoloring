...
\begin{tabular}{c c c c c }
\hline
Name & FF & SDO $\&$ LDO  & MAX OUT & MIN OUT \\
\hline
hood & 36.5 & 37.2 & 35.9 & 35.9 \\
pkustk10 & 40.5 & 40.9 & 39.3 & 39.5\\
pwtk & 38.8 & 38.8 & 38.8 & 38.8\\
\end{tabular}
\caption{ Average Optimal colors obtained by parallel algorithms.}
\label{tbl:colors}
\end{table}
The results (average of 10 runs) show that MAX and MIN generally yield fewer colors than other algorithms and we also notice that good coloration is obtained at relatively small subgraph sizes.
In terms of speed among the parallel graph coloring algorithms, First Fit is the fastest followed by SDO $\&$ LDO, MIN and MAX which take roughly the same amount of time. The best combination of good coloring and high performance is given by Parallel SDO $\&$ LDO, and it�s running time is within a factor of 2 of sequential First Fit.
