...
The tests were carried out on different categories of real graphs from the University of Florida Sparse Matrix Collection \cite{uofMatrix}. In this paper we will focus on 3 different graphs shown in Table~\ref{tbl:properties}
