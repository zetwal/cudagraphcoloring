...
The MAX OUT and MIN OUT algorithm work like the SDO $\&$ LDO except that where the latter uses saturation to decide which node to color first, MAX OUT uses the maximum number of neighbors of a vertex out of the latter's subgraph and MIN OUT uses the minimum number of neighbors outside of the subgraph respectively. For all of the 4 heuristics, when we have chosen a vertex to color, we consider all the neighbors of the latter both inside and outside the subgraph when allocating colors.\\
...
\textbf{Phase 3: Conflicts Detection}\
...
The tests were carried out on different categories of real graphs from the University of Florida Sparse Matrix Collection []. In this paper we will focus on 3 graphs from the Civil Engineering domain as shown in Table~\ref{tbl:properties}
...
\hline
Name & $n$ & $m$ & $\Delta$ & Avg Degree & FF Colors & SDO $\&$ LDO Col & FF Time & Time \
\\
\hline
pkustk10 & 81,920 & 2,114,154 & 89 & 52 & 42 & 42 & 39 & 226838\\
pkustk11 & 87,804 & 2,565,054 & 131 & 55 & 57 & 51 & 48 & 250112\\
pkustk13 & 94,893 & 3,260,967 & 299 & 68 & 57 & 51 & 66 & 612960\\
\\
\end{tabular}
