...
extern "C"
void cudaGraphColoring(long *compactAdjacencyList, long *vertexStartList, long *boundaryList, long *graphColors, long *degreeList, long *conflict, long boundarySize, long maxDegree, long graphSize, long numEdges)
{
	long *colorsD, *conflictD, *boundaryListD, *degreeListD, *vertexStartListD, *compactAdjacencyListD;     
